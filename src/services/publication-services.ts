...
// Criar Publicação (A data será gerada automaticamente pelo banco)
    ...
    try {
        ...
        await prisma.publication.create({
            data: {
                ...
                // NÃO precisamos passar a data aqui! O banco de dados vai preenchê-la sozinho.
            }
        });
    ...
    try {
        ...
        await prisma.publication.update({
            ...
            data: {
                ...
                content: content,
                instructorId: authorId,
                // A data de criação (createdAt) não muda no update, ela se mantém intacta.
            }
        });
