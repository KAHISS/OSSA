    ...
    useEffect(() => {
      ...
      async function loadCategory() {
        try {
          ...
          const [startAge, finishAge] = (categoria.age_group || "0-0").split("-");
          const [startWeight, finishWeight] = (categoria.weight_range || "0-0").split("-");

          setFormValues({
            id: categoria.id,
            name: categoria.name || "",
            description: categoria.description || "",
            start_age_group: startAge,
            finish_age_group: finishAge,
            start_weight_range: startWeight,
            finish_weight_range: finishWeight,
          });
        } catch (error) {
        ...
        <div className={`my-4 mx-4 md:my-6 md:mx-6 font-thin ${fonts.oswald.className}`}>
          <div className="bg-white rounded-lg border p-6 shadow-sm">
            ...
            <Button asChild className="mt-4">
              <Link href="/painel/categorias">Voltar</Link>
            </Button>
          </div>
        </div>
      );
                ...
                <form ref={formRef} action={formAction} className="space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-2">
                        <label className="text-lg font-semibold text-gray-700 flex items-center gap-2">
                            <FaTag className="text-red-700" /> Editar Categoria
                        </label>
                        <Input 
                            name="name" 
                            required 
                        ...
                        <div className="space-y-4 p-4 border rounded-md bg-zinc-50/50">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <Input
                                      name="start_age_group"
                                      type="number"
                                      required
                                      value={formValues.start_age_group}
                                      onChange={handleChange}
                                      placeholder="0"
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Input
                                      ...
                                      type="number"
                                      required
                                      value={formValues.finish_age_group}
                                      onChange={handleChange}
                                      placeholder="18"
                                      className="h-11 bg-white"
                                    />
                        ...
                        <div className="space-y-4 p-4 border rounded-md bg-zinc-50/50">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <Input
                                      name="start_weight_range"
                                      type="number"
                                      step="0.1"
                                      required
                                      value={formValues.start_weight_range}
                                      onChange={handleChange}
                                      placeholder="0.0"
                                      className="h-11 bg-white"
                                    />
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Input
                                      name="finish_weight_range"
                                      type="number"
                                      step="0.1"
                                      required
                                      value={formValues.finish_weight_range}
                                      onChange={handleChange}
                                      placeholder="120.0"
                                      className="h-11 bg-white"
                                    />
                    ...
                    <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 md:gap-4 pt-6 border-t border-gray-100">
                        ...
                        <Confirmation
                            ...
                            message="Tem certeza que deseja atualizar esta categoria? Esta ação não pode ser desfeita."
                            isPending={isPending}
                            buttonText="Atualizar Categoria"
